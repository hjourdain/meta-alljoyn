...
S = "${WORKDIR}/git"
SRCREV_FORMAT = "alljoyncore"
SRCREV_alljoyncore = "efa50d3e2352002969dd96c3f5e0ec72f8249544"
SRCREV_basealljoyn = "4b5b61c0e6ab2bed44d106866c8c4717ab0aaeb0"
SRC_URI = " \
            git://git.allseenalliance.org/gerrit/core/${PN}.git;protocol=https;name=alljoyncore;destsuffix=git/core/${PN} \
            git://git.allseenalliance.org/gerrit/services/base.git;protocol=https;name=basealljoyn;destsuffix=git/services/base \
          "
...
# ABOUT and CONFIG services are always present
    install -d ${D}/${libdir} ${D}/${includedir}/${PN}/about ${D}/${includedir}/${PN}/config
    install ${S}/core/${PN}/build/openwrt/openwrt/debug/dist/cpp/lib/lib${PN}_about.* ${D}/${libdir}
    install ${S}/core/${PN}/build/openwrt/openwrt/debug/dist/cpp/lib/lib${PN}_config.* ${D}/${libdir}
    install ${S}/core/${PN}/build/openwrt/openwrt/debug/dist/cpp/inc/${PN}/about/*.h ${D}/${includedir}/${PN}/about
    install ${S}/core/${PN}/build/openwrt/openwrt/debug/dist/cpp/inc/${PN}/config/*.h ${D}/${includedir}/${PN}/config
